    ...
    <body>
        ...
        <section class="main-top position-relative">
            <div class="container position-relative">
                ...
                <img src="static/png/Rectangle.png" class="img-fluid position-absolute top-25 start-0"
                    style="z-index: 1;">
                <div class="position-absolute top-100 start-50" style="z-index: 3;">
                    <h1>Left in the cold, dogs like tiny need your help.</h1>
                    <p id="top-text">This Christmas, will you be a star and help guide dogs like Tiny to their Dogs
                        Trust
                        miracle?
                    </p>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="card border-0 bg-transparent" id="card1">
                                                        <div class="card-img-container position-relative">
                                                            ...
                                                            <img src="static/png/card-background.png"
                                                                class="card-img-bottom">
                                                            <div
                                                                class="card-body position-absolute top-0 start-50 translate-middle-x">
